...
const DriverRides: React.FC = () => {
  ...
  const fetchRides = async () => {
    try {
      setIsLoading(true);
      const response = await driverAPI.getMyRides(currentPage, 10);
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600">View your ride history and earnings</p>
      </div>
      ...
      {rides.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600">Start accepting rides to see your history here!</p>
        </div>
      ) : (
